...
func (m *Manager) geoLoop() {
	m.refreshLoop("geo", m.currentGeoRefresh, m.geoStale, func() error {
		_, err := m.RefreshGeo()
		return err
	})
}
...
func (m *Manager) ipListLoop() {
	m.refreshLoop("iplist", m.currentIPListRefresh, m.ipListStale, func() error {
...
func (m *Manager) refreshLoop(what string, cadence func() time.Duration, isStale func(time.Duration) bool, refresh func() error) {
	for {
