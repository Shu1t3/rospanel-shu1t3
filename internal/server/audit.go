...
var auditActions = map[string]auditRoute{
	...
	"POST /api/nodes/{id}/mtproto":             set("mtproto"),
	...
	"POST /api/external":                       set("external"),
	"DELETE /api/external/{id}":                set("external"),
	...
	"POST /api/mtproto":                        set("mtproto"),
	"PUT /api/mtproto/{id}":                    set("mtproto"),
	"DELETE /api/mtproto/{id}":                 set("mtproto"),
	"POST /api/mtproto/{id}/toggle":            set("mtproto"),
	"POST /api/mtproto/gen-secret":             skip,
	...
	"POST /api/connections/reset":              set("connections"),
